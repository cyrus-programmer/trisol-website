      ...
      hexagonsRef.current.forEach((h) => {
        ...
        ctx.strokeStyle =
          proximity > 0.3
            ...
            : `rgba(40,42,114,${strokeOpacity * 1.2})`;
    ...
    >
      <div
        style={{
          ...
          height: "120%",
          background:
            "radial-gradient(ellipse at 30% 40%, rgba(40,42,114,0.5) 0%, transparent 65%)",
      ...
      <div
        style={{
          ...
          height: 600,
          background:
            "radial-gradient(circle, rgba(253,189,16,0.15) 0%, transparent 60%)",
          filter: "blur(60px)",
    ...
    <div ref={ref} style={{ flex: 1 }}>
      <div
        style={{
          ...
          lineHeight: 1,
          letterSpacing: "-1px",
          textShadow: "0 0 20px rgba(253,189,16,0.3)",
        }}
      >
        {val}
        {suffix}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            style={{
              color: "#fdbd10",
              textShadow:
                "0 0 60px rgba(253,189,16,0.4), 0 0 30px rgba(253,189,16,0.2)",
            }}
          >
            millions.
          </span>
        ...
        >
          Trisol Technologies ships production-grade Flutter apps powered by AI.
        ...
        >
          ...
          <a
            ...
            style={{
              ...
              border: "1.5px solid rgba(253,189,16,0.25)",
              color: "#eeeaf8",
              padding: "0.95rem 2.2rem",
              borderRadius: 10,
              fontFamily: "var(--font-body)",
          ...
          {[1, 2, 3].map((i) => (
            <div
              ...
              style={{
                ...
                width: 140 + i * 72,
                height: 140 + i * 72,
                border: `1px solid rgba(253,189,16,${0.25 - i * 0.08})`,
                borderRadius: 28 + i * 14,
                animation: `ringPulse ${2.5 + i * 0.8}s ease-in-out ${i * 0.5}s infinite`,
                pointerEvents: "none",
              }}
            />
          ))}

...
const contactInfo = [
  ...
  { icon: Mail, label: "Email", value: "trisoltechnologies786@gmail.com" },
  {
    ...
    label: "Office",
    value:
      "Office 4, Floor 2, Plaza 123, Spring North, Phase 7 Bahria Town, Rawalpindi",
  },
];
    ...
    <FadeIn delay={index * 0.08}>
      <div
        ...
        style={{
          ...
          border: "1px solid rgba(40,42,114,0.26)",
          borderRadius: 18,
        ...
        >
          ...
          <span
            style={{
              ...
              border: "1px solid rgba(40,42,114,0.45)",
...
function ContactInfoItem({ item, delay }) {
  const Icon = item.icon;
  return (
    <FadeIn delay={delay}>
      <div
        ...
        onMouseLeave={(e) => {
          e.currentTarget.style.borderColor = "rgba(40,42,114,0.26)";
        }}
      >
        <div
          style={{
        ...
        >
          <Icon size={15} color="#fdbd10" strokeWidth={1.8} />
        </div>
        <div>
          <div
            style={{
...
export default function Partnership() {
  ...
  const inputStyle = {
    background: "rgba(40,42,114,0.1)",
    border: "1px solid rgba(40,42,114,0.3)",
    borderRadius: 10,
    padding: "0.8rem 1rem",
    color: "#eeeaf8",
    fontSize: "0.88rem",
  ...
  const onF = (e) => {
    e.target.style.borderColor = "rgba(253,189,16,0.38)";
  };
  const onB = (e) => {
    e.target.style.borderColor = "rgba(40,42,114,0.3)";
  };
  ...
  return (
    <section
      ...
      style={{
        ...
        background:
          "linear-gradient(180deg, transparent, rgba(40,42,114,0.04), transparent)",
      }}
    >
      <div style={{ maxWidth: 1300, margin: "0 auto" }}>
        <FadeIn>
          <div style={{ marginBottom: "4rem", maxWidth: 640 }}>
            ...
            >
              We're open to co-builds, white-label deals, acquisitions, and
              strategic partnerships. If you see overlap, reach out — we move
              fast.
            </p>
          </div>
        </FadeIn>
        ...
        >
          {partnerTypes.map((p, i) => (
            <PartnerCard key={p.title} item={p} index={i} />
          ))}
        </div>
        ...
        >
          ...
          >
            ...
            {contactInfo.map((item, i) => (
              <ContactInfoItem key={item.label} item={item} delay={i * 0.07} />
            ))}
          </div>
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    if (!sent) e.currentTarget.style.background = "#ffc929";
                  }}
                  onMouseLeave={(e) => {
                    if (!sent) e.currentTarget.style.background = "#fdbd10";
                  }}
                >
                  {sent ? (
                    "Sent ✓"
                    ...
                    <>
                      {" "}
                      Send Proposal <ArrowRight size={15} />
                    </>
                  )}
                </button>
              </form>
      ...
      <style>{`
        ...
        @media (max-width: 960px) {
          ...
          .partner-types-grid { grid-template-columns: 1fr 1fr !important; }
        }
